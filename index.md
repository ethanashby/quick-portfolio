...
During the summer of 2020, I worked in the Department of Epidemiology and Biostatistics at Memorial Sloan Kettering Cancer Center under the mentorship of Dr. Ronglai Shen and Dr. Saptarshi Chakraborty to extract clinically-relevant signals from rare mutations in the cancer genome. Identifying a cancer’s tissue of origin using the mutations in its genome sequence is a critical challenge in precision oncology, with important clinical applications like testing for clonal relatedness in metastatic cancers, classifying cancers of unknown primary site, or in emerging diagnostics like “liquid biopsy” screens of circulating tumor DNA in the blood. The preponderance of somatic mutation in cancer is rare: >90% of all mutations encountered in The Cancer Genome Atlas (TCGA) are only catalogued once, meaning that they are unique to the tumor they were sequenced in. Traditional methods to determine primary site focus on common mutations (in the word cloud above, analogous to the few large words), neglecting the vast amount of rare mutations. In previous research, my mentors used nonparametric, Bayesian methods develop in the fields of computational linguistics and ecology to mine tissue-specific signals from rare mutations (in the word cloud above, analogous to the diverse collection of green words) in major cancer genes (Chakraborty et al., Nature Communications 10:1-9, 2019). The majority of genes were omitted from analysis due to sparse mutation data. We developed a framework to resolvve mutation data sparseness and extend this analysis to all genes in the human genome, by using unsupervised clustering to build gene groups defined by biological variables known to correlate with somatic mutation rate. This project was a step towards harnessing the preponderance of previously neglected mutation data for important clinical purposes.
