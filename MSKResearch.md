...
I extended my mentor's analysis to somatic variant mutation data from <a href="https://bioinformatics.mdanderson.org/public-software/tcma/">The Cancer Mitchondria Atlas</a> , to explore if unseen variant probabilities in mitochondrial genome features encode tissue specific signals. This represented a further effort to use the preponderance of previously neglected mutational information for important clinical tasks. 
...
[My slide deck](/MSK Presentation slides.pdf)
